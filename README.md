...
```
cd existing_repo
git remote add origin https://gitlab.com/michael.eligoyo.flora/landed-cost.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/michael.eligoyo.flora/landed-cost/-/settings/integrations)
